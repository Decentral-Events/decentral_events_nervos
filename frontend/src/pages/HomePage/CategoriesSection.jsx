import Category1Image from "../../Images/1.webp";
import Category2Image from "../../Images/sports.webp";
import Category3Image from "../../Images/conferences.webp";
import Category4Image from "../../Images/expos.webp";
import Category5Image from "../../Images/festival.webp";
import Category6Image from "../../Images/arts.webp";
import Category7Image from "../../Images/community.webp";
import Category8Image from "../../Images/politics.webp";
import Category9Image from "../../Images/academics.webp";
import { Link } from "react-router-dom";

function CategoriesSection() {
    return <div className="features categories" style={{ paddingTop: '14rem' }}>
        <h2 className="features-head">Categories</h2>
        ...
        <div className="features-card-cont">
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-1">
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-2">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-3">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-5">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-6">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-7">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-8">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
            ...
            <div className="features-card categories-card">
                ...
                <div className="categort-txt-cont">
                    ...
                    <div className="header-button-cont categories-btn-cont">
                        <Link to="/events" className="btn ctg-btn ctg-btn-9">
                            <span className="btn-visible categories-btn-txt">Learn More</span>
                        </Link>
                    </div>
                </div>
