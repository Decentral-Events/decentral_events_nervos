...
function CancelledEventReservations() {
    ...
    useEffect(() => {
        ...
        (async () => {
            const { data: { reservations, totalPages } } = await axios(`${window.server}/reservation/cancelled?page=${currentPage}&limit=10`, {
                headers: {
...
export default CancelledEventReservations;